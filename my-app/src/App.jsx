      ...
      <header className="w-full border-b border-gray-200">
        <div className="container mx-auto flex items-center justify-between p-2">
          ...
          <nav className="flex items-center gap-4">
            ...
            <a href="/projects" className="p-2 font-medium hover:opacity-75 transition-opacity	">Projects</a>
            <a href="/about" className="p-2 font-medium hover:opacity-75 transition-opacity	">About</a>
            <a href="/contact" className="p-2 font-medium hover:opacity-75 transition-opacity	">Contact</a>
          </nav>
        </div>
      </header>
